    ...
    if opcionUsuario == 1:
        ...
        for persona in listaUsuarios:
            if persona["id"] == idBuscado:
                ...
                elif opcionActializacion == 2:
                    print("Ingresa el nuevo apellido:")
                    persona["apellido"] = input()

                elif opcionActializacion == 3:
                    print("Ingresa la nueva edad:")
                    persona["edad"] = input()

                elif opcionActializacion == 4:
                    print("Ingresa el nuevo numero:")
                    persona["numero"] = int(input())

                elif opcionActializacion == 5:
                    print("Ingresa el nuevo ID:")
                    persona["id"] = int(input())

                else:
                    print("Escoge una opcion de actualización de datos correcta!")
        ...
        print("Ingrese el ID de la persona a la cual deseas eliminar")
        idBuscado = int(input())
        ...
        print("Opción inválida, por favor verifique y seleccione una de las opciones dadas.")
